...
public class Project {
    ...
    //Verify that the swag labs text is displayed on the homepage.
    ...
    public void registerUser() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@id='customer.username']")).sendKeys("TASCohorta");
        ...
        softA.assertEquals(welcomeText, "Welcome TASCohortw");
...
//        destinationField.sendKeys(Keys.COMMAND + "v");
    ...
    public void projectLunch() throws InterruptedException {
        ...
        // Launch a new window using JavaScript
